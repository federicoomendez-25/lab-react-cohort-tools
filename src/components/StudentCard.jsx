...
function StudentCard({
  ...
  return (
    <Link to={`/students/${_id}`}>
      <div
        className={`StudentCard flex justify-between items-center p-3 mb-2 bg-white shadow-sm rounded border border-gray-200 hover:bg-gray-100 cursor-pointer ${className}`}
      >
        <span
